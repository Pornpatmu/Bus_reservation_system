CREATE DATABASE  IF NOT EXISTS `bus_reservation_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `reservations` (
  ...
  CONSTRAINT `reservations_ibfk_2` FOREIGN KEY (`trip_id`) REFERENCES `trips` (`trip_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `routes` (
  ...
  CONSTRAINT `routes_ibfk_1` FOREIGN KEY (`departure_station_id`) REFERENCES `stations` (`station_id`),
...
-- Dump completed on 2025-01-27 19:01:14
